...
title: "代码编辑器和正则表达式"
date: "2022-11-28"
description: "VS Code高效编辑技巧与正则表达式入门，掌握多行同步编辑和文本匹配替换方法，提升代码编写效率。"
tags:
  - vscode
---
...
![多行同步插入](/images/editor-and-regular/多行同步插入.gif)

**同步追加**

选中多行文本，按下 `Option + Shift + I`，此时选中行行尾出现多个光标，输入内容，多个光标会同步追加。

![多行同步追加](/images/editor-and-regular/多行同步追加.gif)
...
![选中相同文本并同步替换／插入](/images/editor-and-regular/选中相同字符并同步替换.gif)
...
![大小写转换](/images/editor-and-regular/regular.png)
...
![开启正则匹配](/images/editor-and-regular/regular.png)
